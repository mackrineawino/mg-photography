  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <div>
        ...
        <div className='flex justify-between text-[30px] mx-[10px] lg:text-[40px] mt-[-50px] pb-[50px] mb-[30px] text-[#cc7656] text-center' style={{ position: 'relative', zIndex: 20 }}>
          <div className='hover:text-[50px] mx-[10px] bg-gray-500 w-[150px] h-[130px]  flex justify-center items-center shadow-lg rounded-md ml-[50px] '>
          ...
          <div className='hover:text-[50px] mx-[10px] bg-gray-500 w-[150px] h-[130px]  flex justify-center items-center shadow-lg rounded-md'>
          ...
          <div className='hover:text-[50px] mx-[10px] bg-gray-500 w-[150px] h-[130px]  flex justify-center items-center shadow-lg rounded-md mr-[50px]'>
            <a href='/'>
              <div className="rounded-full bg-blue-600 p-2  flex items-center justify-center" style={{ width: '70px', height: '70px', overflow: 'hidden' }}>
        ...
        <div className='flex flex-col lg:flex-row items-center justify-between mt-[50px] mb-[80px] mx-[40px] '>
          <div className='mx-[40px]  flex  flex-col justify-center items-center'>
            <form onSubmit={handleSubmit} className='md:w-[600px] w-[300px] lg:w-[600px]  bg-gradient-to-b from-blue-600 p-8 rounded-md  transition-all duration-300 hover:scale-105 font-[Helvetica]'>
              {successMessage && (
              ...
              <input type="text" value={name}
                onChange={(e) => setName(e.target.value)} id="name" name="name" placeholder='Enter Your Name' className='placeholder:text-[15px] pl-[10px] w-[100%]  py-[6px] rounded-md focus:outline-none' required /><br></br><br></br>

              <label htmlFor="email" className='pl-[10px]'>Email</label><br></br>
              <input type="email" value={email}
                onChange={(e) => setEmail(e.target.value)} id="email" name="email" placeholder='Enter Your Email' className=' placeholder:text-[15px] pl-[10px] w-[100%]  py-[6px] rounded-md focus:outline-none' required /><br></br><br></br>

              <label htmlFor="message" className='pl-[10px]'>Message</label><br></br>
              <textarea id="message" value={message}
                onChange={(e) => setMessage(e.target.value)} name="message" rows="4" placeholder='Type Your Message' className='placeholder:text-[15px] pl-[10px] w-[100%]  rounded-md focus:outline-none bg-none' required></textarea><br></br>

              <button type="submit" className=' bg-blue-700  text-white w-[100%] py-[6px] mt-[50px] mb-[50px] rounded-md transition-all duration-300 hover:scale-105' disabled={loading}> {loading ? (
          ...
          <a href='/about'>
            <div className='bg-gray-500 shadow-2xl rounded-md  md:w-[600px] w-[300px] lg:w-[500px] h-[570px]  flex flex-col justify-end items-center' style={{ backgroundImage: `url('${baby}')`, backgroundPosition: 'center', backgroundSize: '700px', backgroundRepeat: 'no-repeat' }}>
